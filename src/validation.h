...
static const size_t MAX_CONTRACT_VOUTS = 1000; // ecoc
 ...
 */
bool ProcessNewBlockHeaders(const std::vector<CBlockHeader>& block, CValidationState& state, const CChainParams& chainparams, const CBlockIndex** ppindex=NULL, CBlockHeader *first_invalid=nullptr,  const CBlockIndex** pindexFirst=nullptr);
...
public:
    ...
    bool extractionQtumTransactions(ExtractQtumTX& ecocTx);
