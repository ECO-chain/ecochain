...
void RPCNestedTests::rpcNestedTests()
{
    ...
    globalState = std::unique_ptr<QtumState>(new EcocState(dev::u256(0), EcocState::openDB(pathTemp.string(), hashDB, dev::WithExisting::Trust), pathTemp.string(), dev::eth::BaseState::Empty));
    dev::eth::ChainParams cp((dev::eth::genesisInfo(dev::eth::Network::ecocTestNetwork)));
