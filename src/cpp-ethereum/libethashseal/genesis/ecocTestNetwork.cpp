...
static dev::h256 const c_genesisStateRootEcocTestNetwork("2ebd2f054ed409f4bc77921ce642517eb574470c01772dc26658d016a4ccc825");
static std::string const c_genesisInfoEcocTestNetwork = std::string() +
R"E(
{
	"sealEngine": "Ethash",
	"params": {
