...
#include "genesis/ecocMainNetwork.cpp"
#include "genesis/ecocTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
	...
	case Network::ecocMainNetwork: return c_genesisInfoEcocMainNetwork;
	case Network::ecocTestNetwork: return c_genesisInfoEcocTestNetwork;
	default:
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
	...
	case Network::ecocMainNetwork: return c_genesisStateRootEcocMainNetwork;
	case Network::ecocTestNetwork: return c_genesisStateRootEcocTestNetwork;
	default:
		throw std::invalid_argument("Invalid network value");
	}
}
