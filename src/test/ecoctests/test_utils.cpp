...
void initState(){
    ...
    const std::string dir = pathTemp.string();
    const dev::h256 hashDB(dev::sha3(dev::rlp("")));
    globalState = std::unique_ptr<QtumState>(new QtumState(dev::u256(0), QtumState::openDB(dir, hashDB, dev::WithExisting::Trust), dir + "/ecocDB", dev::eth::BaseState::Empty));
...
QtumTransaction createEcocTransaction(valtype data, dev::u256 value, dev::u256 gasLimit, dev::u256 gasPrice, dev::h256 hashTransaction, dev::Address recipient, int32_t nvout){
