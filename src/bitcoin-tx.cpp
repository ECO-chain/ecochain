...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s ecoc-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  ecoc-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ecoc transaction") + "\n" +
              "  ecoc-tx [options] -create [commands]   " + _("Create hex-encoded ecoc transaction") + "\n" +
              "\n";
