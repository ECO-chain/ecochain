#ifndef ECOCVERSIONCHECKER_H
#define ECOCVERSIONCHECKER_H

#include <QObject>

#define ECOC_RELEASES "https://github.com/ecocchain/ecoc/releases"
...
class EcocVersionChecker : public QObject
{
    Q_OBJECT
public:
    explicit EcocVersionChecker(QObject *parent = 0);
    ~EcocVersionChecker();
