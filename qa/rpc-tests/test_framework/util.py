...
def initialize_datadir(dirname, n):
    ...
    with open(os.path.join(datadir, "ecoc.conf"), 'w', encoding='utf8') as f:
        f.write("regtest=1\n")
...
def initialize_chain(test_dir, num_nodes, cachedir):
    ...
    if create_cache:
        ...
        for i in range(MAX_NODES):
            ...
            args = [ os.getenv("BITCOIND", "ecocd"), "-server", "-keypool=1", "-datadir="+datadir, "-discover=0", "-staking=0" ]
            if i > 0:
...
def start_node(i, dirname, extra_args=None, rpchost=None, timewait=None, binary=None):
    ...
    if binary is None:
        binary = os.getenv("BITCOIND", "ecocd")
