...
void CTxMemPool::check(const CCoinsViewCache *pcoins) const
{
  ecoc::ecocLogFun(__PRETTY_FUNCTION__);
    ...
    ecoc::ecocLogNL("nCheckFrequency ="); ecoc::ecocLog(nCheckFrequency);
    ecoc::ecocLogNL("GetRand(std::numeric_limits<uint32_t>::max()) ="); ecoc::ecocLog(GetRand(std::numeric_limits<uint32_t>::max()));
