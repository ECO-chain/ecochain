...
static const unsigned int DEFAULT_BLOCK_MAX_SIZE = ecoc::blockSizeLimit*0.95;
/** Default for -blockprioritysize, maximum space for zero/low-fee transactions **/
static const unsigned int DEFAULT_BLOCK_PRIORITY_SIZE = 0;
/** Default for -blockmaxweight, which controls the range of block weights the mining code will create **/
static const unsigned int DEFAULT_BLOCK_MAX_WEIGHT = ecoc::blockSizeLimit*0.95*WITNESS_SCALE_FACTOR;
...
/** The minimum gas that can be paid to the minter
 *  per transaction.
 */
static const unsigned int MIN_TX_GAS = ecoc::minTxGas;
