...
public:
	...
	virtual void addBalance(Address const& _id, u256 const& _amount); // qtum made this function virtual , so it can be ovverrided
...
// private:
protected: // qtum changed  the following to protected from private
