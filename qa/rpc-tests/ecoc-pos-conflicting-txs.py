...
"""
class EcocPOSConflictingStakingMempoolTxTest(BitcoinTestFramework):
    def __init__(self):
        super().__init__()
        self.num_nodes = 2
    ...
    def run_test(self):
        ...
        # Allow the ecoc staker some time to run (since we set a mocktime the time will not advance)
        time.sleep(80)
...
if __name__ == '__main__':
    EcocPOSConflictingStakingMempoolTxTest().main()
