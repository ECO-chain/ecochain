...
const char * const BITCOIN_CONF_FILENAME = "ecoc.conf";
const char * const BITCOIN_PID_FILENAME = "ecocd.pid";
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Ecoc
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Ecoc
    // Mac: ~/Library/Application Support/Ecoc
    // Unix: ~/.ecoc
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Ecoc";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Ecoc";
#else
    // Unix
    return pathRet / ".ecoc";
#endif
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    if (strprintf(COPYRIGHT_HOLDERS, COPYRIGHT_HOLDERS_SUBSTITUTION).find("Ecoc Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The Eco chain dev team";
    }
