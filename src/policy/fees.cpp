                                         ...
                                         std::vector<const CTxMemPoolEntry*>& entries)
{
    if (nBlockHeight <= nBestSeenHeight) {
      ecoc::ecocLog("nBlockHeight lower than BestSeenHeight");
      ecoc::ecocLog("nBlockHeight="); ecoc::ecocLog(std::to_string(nBlockHeight));
      ecoc::ecocLog("BestSeenHeight="); ecoc::ecocLog(std::to_string(nBestSeenHeight));
