...
UniValue getnewaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() > 1)
        throw runtime_error(
            ...
            "\nReturns a new Ecochain address for receiving payments.\n"
            "If 'account' is specified (DEPRECATED), it is added to the address book \n"
            "so payments received with the address will be credited to 'account'.\n"
            "\nArguments:\n"
            "1. \"account\"        (string, optional) DEPRECATED. The account name for the address to be linked to. If not provided, the default account \"\" is used. It can also be set to the empty string \"\" to represent the default account. The account does not need to exist, it will be created if there is no account by the given name.\n"
            "\nResult:\n"
            "\"address\"    (string) The new ecoc address\n"
            "\nExamples:\n"
...
UniValue getaccountaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 1)
        throw runtime_error(
            ...
            "\nDEPRECATED. Returns the current Ecochain address for receiving payments to this account.\n"
            "\nArguments:\n"
            "1. \"account\"       (string, required) The account name for the address. It can also be set to the empty string \"\" to represent the default account. The account does not need to exist, it will be created and a new address created  if there is no account by the given name.\n"
            "\nResult:\n"
            "\"address\"          (string) The account ecoc address\n"
            "\nExamples:\n"
...
UniValue getrawchangeaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() > 1)
        throw runtime_error(
            "getrawchangeaddress\n"
            "\nReturns a new Ecochain address, for receiving change.\n"
...
UniValue setaccount(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"         (string, required) The ecochain address to be associated with an account.\n"
            "2. \"account\"         (string, required) The account to assign the address to.\n"
            "\nExamples:\n"
            + HelpExampleCli("setaccount", "\"EeHoFeeGsK8np3smxFuxDC9QDr9bH6TjzU\" \"tabby\"")
            + HelpExampleRpc("setaccount", "\"EeHoFeeGsK8np3smxFuxDC9QDr9bH6TjzU\", \"tabby\"")
        );
    ...
    if (!address.IsValid())
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid Ecoc address");
...
UniValue getaccount(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 1)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"         (string, required) The ecochain address for account lookup.\n"
            "\nResult:\n"
            "\"accountname\"        (string) the account address\n"
            "\nExamples:\n"
            + HelpExampleCli("getaccount", "\"EeHoFeeGsK8np3smxFuxDC9QDr9bH6TjzU\"")
            + HelpExampleRpc("getaccount", "\"EeHoFeeGsK8np3smxFuxDC9QDr9bH6TjzU\"")
        );
    ...
    CBitcoinAddress address(request.params[0].get_str());
    if (!address.IsValid())
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid Ecochain address");
...
UniValue getaddressesbyaccount(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 1)
        throw runtime_error(
            ...
            "  \"address\"         (string) an ecochain address associated with the given account\n"
            "  ,...\n"
            "]\n"
            "\nExamples:\n"
...
UniValue sendtoaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 7)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"            (string, required) The ecoc address to send to.\n"
            ...
            "                             The recipient will receive less ecoc than you enter in the amount field.\n"
            "6. \"senderaddress\"      (string, optional) The ecochain address that will be used to send money from.\n"
            "7. \"changeToSender\"     (bool, optional, default=false) Return the change to the sender.\n"
            "\nResult:\n"
            "\"txid\"                  (string) The transaction id.\n"
            "\nExamples:\n"
            + HelpExampleCli("sendtoaddress", "\"EeHoFeeGsK8np3smxFuxDC9QDr9bH6TjzU\" 0.1")
            + HelpExampleCli("sendtoaddress", "\"EeHoFeeGsK8np3smxFuxDC9QDr9bH6TjzU\" 0.1 \"donation\" \"seans outpost\"")
            + HelpExampleCli("sendtoaddress", "\"EeHoFeeGsK8np3smxFuxDC9QDr9bH6TjzU\" 0.1 \"\" \"\" true")
            + HelpExampleCli("sendtoaddress", "\"EeHoFeeGsK8np3smxFuxDC9QDr9bH6TjzU\", 0.1, \"donation\", \"seans outpost\", false, \"QX1GkJdye9WoUnrE2v6ZQhQ72EUVDtGXQX\", true")
            + HelpExampleRpc("sendtoaddress", "\"EeHoFeeGsK8np3smxFuxDC9QDr9bH6TjzU\", 0.1, \"donation\", \"seans outpost\"")
            + HelpExampleRpc("sendtoaddress", "\"EeHoFeeGsK8np3smxFuxDC9QDr9bH6TjzU\", 0.1, \"donation\", \"seans outpost\", false, \"QX1GkJdye9WoUnrE2v6ZQhQ72EUVDtGXQX\", true")
        );
    ...
    senderAddress.SetString(request.params[5].get_str());
        if (!senderAddress.IsValid())
            throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid Ecochain address to send from");
        else
            fHasSender=true;
    }
...
UniValue createcontract(const JSONRPCRequest& request){
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 6)
        throw runtime_error(
                ...
                "3. gasPrice  (numeric or string, optional) gasPrice ecoc price per gas unit, default: "+FormatMoney(nGasPrice)+", min:"+FormatMoney(minGasPrice)+"\n"
                "4. \"senderaddress\" (string, optional) The ecochain address that will be used to create the contract.\n"
...
UniValue sendtocontract(const JSONRPCRequest& request){
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 8)
        throw runtime_error(
                ...
                "5. gasPrice  (numeric or string, optional) gasPrice Ecoc price per gas unit, default: "+FormatMoney(nGasPrice)+", min:"+FormatMoney(minGasPrice)+"\n"
                "6. \"senderaddress\" (string, optional) The ecochain address that will be used as sender.\n"
...
UniValue listaddressgroupings(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp)
        throw runtime_error(
            ...
            "  [\n"
            "    [\n"
            "      \"address\",            (string) The ecochain address\n"
...
UniValue signmessage(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 2)
        throw runtime_error(
            ...
            + HelpRequiringPassphrase() + "\n"
            "\nArguments:\n"
            "1. \"address\"         (string, required) The ecochain address to use for the private key.\n"
            ...
            "\nAs json rpc\n"
            + HelpExampleRpc("signmessage", "\"EdvKc28xAwZfN1GvUix8rydb2MrH4hmYvK\", \"my message\"")
        );
...
UniValue getreceivedbyaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"         (string, required) The ecochain address for transactions.\n"
            "2. minconf             (numeric, optional, default=1) Only include transactions confirmed at least this many times.\n"
            "\nResult:\n"
            "amount   (numeric) The total amount in " + CURRENCY_UNIT + " received at this address.\n"
            "\nExamples:\n"
            "\nThe amount from transactions with at least 1 confirmation\n"
            + HelpExampleCli("getreceivedbyaddress", "\"EdvKc28xAwZfN1GvUix8rydb2MrH4hmYvK\"") +
            "\nThe amount including unconfirmed transactions, zero confirmations\n"
            + HelpExampleCli("getreceivedbyaddress", "\"EdvKc28xAwZfN1GvUix8rydb2MrH4hmYvK\" 0") +
            "\nThe amount with at least 6 confirmation, very safe\n"
            + HelpExampleCli("getreceivedbyaddress", "\"EdvKc28xAwZfN1GvUix8rydb2MrH4hmYvK\" 6") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("getreceivedbyaddress", "\"EdvKc28xAwZfN1GvUix8rydb2MrH4hmYvK\", 6")
       );
...
UniValue sendfrom(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 3 || request.params.size() > 6)
        throw runtime_error(
            ...
            "\nDEPRECATED (use sendtoaddress). Sent an amount from an account to an ecochain address."
            + HelpRequiringPassphrase() + "\n"
            "\nArguments:\n"
            ...
            "                       the spend.\n"
            "2. \"toaddress\"         (string, required) The ecochain address to send funds to.\n"
            ...
            + HelpExampleCli("sendfrom", "\"\" \"EdvKc28xAwZfN1GvUix8rydb2MrH4hmYvK\" 0.01") +
            "\nSend 0.01 from the tabby account to the given address, funds must have at least 6 confirmations\n"
            + HelpExampleCli("sendfrom", "\"tabby\" \"EdvKc28xAwZfN1GvUix8rydb2MrH4hmYvK\" 0.01 6 \"donation\" \"seans outpost\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendfrom", "\"tabby\", \"EdvKc28xAwZfN1GvUix8rydb2MrH4hmYvK\", 0.01, 6, \"donation\", \"seans outpost\"")
        );
...
UniValue sendmany(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 5)
        throw runtime_error(
            ...
            "    {\n"
            "      \"address\":amount   (numeric or string) The ecochain address is the key, the numeric amount (can be string) in " + CURRENCY_UNIT + " is the value\n"
            "      ,...\n"
            "    }\n"
            ...
            "                           Those recipients will receive less ECOC coins than you enter in their corresponding amount field.\n"
            ...
            + HelpExampleCli("sendmany", "\"\" \"{\\\"EdvKc28xAwZfN1GvUix8rydb2MrH4hmYvK\\\":0.01,\\\"EeHoFeeGsK8np3smxFuxDC9QDr9bH6TjzU\\\":0.02}\"") +
            "\nSend two amounts to two different addresses setting the confirmation and comment:\n"
            + HelpExampleCli("sendmany", "\"\" \"{\\\"EdvKc28xAwZfN1GvUix8rydb2MrH4hmYvK\\\":0.01,\\\"EeHoFeeGsK8np3smxFuxDC9QDr9bH6TjzU\\\":0.02}\" 6 \"testing\"") +
            "\nSend two amounts to two different addresses, subtract fee from amount:\n"
            + HelpExampleCli("sendmany", "\"\" \"{\\\"EdvKc28xAwZfN1GvUix8rydb2MrH4hmYvK\\\":0.01,\\\"EeHoFeeGsK8np3smxFuxDC9QDr9bH6TjzU\\\":0.02}\" 1 \"\" \"[\\\"EQjcYkGW3faMhFQmb7mTn8dngH2tM4CLe3\\\",\\\"EJkLgrQHif7zwM4fjDaFsUwg3xx1mLWV2q\\\"]\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendmany", "\"\", \"{\\\"EdvKc28xAwZfN1GvUix8rydb2MrH4hmYvK\\\":0.01,\\\"EeHoFeeGsK8np3smxFuxDC9QDr9bH6TjzU\\\":0.02}\", 6, \"testing\"")
        );
    ...
    BOOST_FOREACH(const string& name_, keys)
    {
        ...
        if (!address.IsValid())
            throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, string("Invalid Ecochain address: ")+name_);
...
UniValue sendmanywithdupes(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 5)
        throw runtime_error(
            ...
            "\nExamples:\n"
            "\nSend two amounts to two different addresses:\n"
            + HelpExampleCli("sendmanywithdupes", "\"\" \"{\\\"EJkLgrQHif7zwM4fjDaFsUwg3xx1mLWV2q\\\":0.01,\\\"EdvKc28xAwZfN1GvUix8rydb2MrH4hmYvK\\\":0.02}\"") +
            "\nSend two amounts to two different addresses setting the confirmation and comment:\n"
            + HelpExampleCli("sendmanywithdupes", "\"\" \"{\\\"EJkLgrQHif7zwM4fjDaFsUwg3xx1mLWV2q\\\":0.01,\\\"EdvKc28xAwZfN1GvUix8rydb2MrH4hmYvK\\\":0.02}\" 6 \"testing\"") +
            "\nSend two amounts to two different addresses, subtract fee from amount:\n"
            + HelpExampleCli("sendmanywithdupes", "\"\" \"{\\\"EJkLgrQHif7zwM4fjDaFsUwg3xx1mLWV2q\\\":0.01,\\\"EdvKc28xAwZfN1GvUix8rydb2MrH4hmYvK\\\":0.02}\" 1 \"\" \"[\\\"EeHoFeeGsK8np3smxFuxDC9QDr9bH6TjzU\\\",\\\"EQjcYkGW3faMhFQmb7mTn8dngH2tM4CLe3\\\"]\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendmanywithdupes", "\"\", \"{\\\"EJkLgrQHif7zwM4fjDaFsUwg3xx1mLWV2q\\\":0.01,\\\"EdvKc28xAwZfN1GvUix8rydb2MrH4hmYvK\\\":0.02}\", 6, \"testing\"")
        );
...
UniValue addmultisigaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 3)
    {
        string msg = "addmultisigaddress nrequired [\"key\",...] ( \"account\" )\n"
            ...
            "Each key is an ecochain address or hex-encoded public key.\n"
            "If 'account' is specified (DEPRECATED), assign address to that account.\n"

            "\nArguments:\n"
            "1. nrequired        (numeric, required) The number of required signatures out of the n keys or addresses.\n"
            "2. \"keys\"         (string, required) A json array of ecoc addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"address\"  (string) ecoc address or hex-encoded public key\n"
            "       ...,\n"
            "     ]\n"
            "3. \"account\"      (string, optional) DEPRECATED. An account to assign the addresses to.\n"

            "\nResult:\n"
            "\"address\"         (string) An ecochain address associated with the keys.\n"

            "\nExamples:\n"
            "\nAdd a multisig address from 2 addresses\n"
            + HelpExampleCli("addmultisigaddress", "2 \"[\\\"EQjcYkGW3faMhFQmb7mTn8dngH2tM4CLe3\\\",\\\"EdvKc28xAwZfN1GvUix8rydb2MrH4hmYvK\\\"]\"") +
            "\nAs json rpc call\n"
            + HelpExampleRpc("addmultisigaddress", "2, \"[\\\"EQjcYkGW3faMhFQmb7mTn8dngH2tM4CLe3\\\",\\\"EdvKc28xAwZfN1GvUix8rydb2MrH4hmYvK\\\"]\"")
        ;
...
UniValue listtransactions(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() > 4)
        throw runtime_error(
            ...
            "    \"address\":\"address\",    (string) The ecochain address of the transaction. Not present for \n"
...
UniValue listsinceblock(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp)
        throw runtime_error(
            ...
            "    \"address\":\"address\",    (string) The ecochain address of the transaction. Not present for move transactions (category = move).\n"
...
UniValue gettransaction(const JSONRPCRequest& request_)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 3)
        throw runtime_error(
            ...
            "      \"address\" : \"address\",          (string) The ecochain address involved in the transaction\n"
...
UniValue walletpassphrase(const JSONRPCRequest& request)
{
    ...
    if (pwalletMain->IsCrypted() && (request.fHelp || request.params.size() < 2 || request.params.size() > 3))
        throw runtime_error(
            ...
            "This is needed prior to performing transactions related to private keys such as sending ECOC coins\n"
            "\nArguments:\n"
...
UniValue encryptwallet(const JSONRPCRequest& request)
{
    ...
    if (!pwalletMain->IsCrypted() && (request.fHelp || request.params.size() != 1))
        throw runtime_error(
            ...
            "\nNow set the passphrase to use the wallet, such as for signing or sending ECOC coins\n"
    ...
    StartShutdown();
    return "wallet encrypted; Ecoc server stopping, restart to run with encrypted wallet. The keypool has been flushed and a new HD seed was generated (if you are using HD). You need to make a new backup.";
}
...
UniValue lockunspent(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw runtime_error(
            ...
            "A locked transaction output will not be chosen by automatic coin selection, when spending ECOC coins.\n"
...
UniValue listunspent(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() > 4)
        throw runtime_error(
            ...
            "3. \"addresses\"    (string) A json array of ecoc addresses to filter\n"
            "    [\n"
            "      \"address\"   (string) ECOC address\n"
            "      ,...\n"
            "    ]\n"
            ...
            "    \"vout\" : n,               (numeric) the vout value\n"
            "    \"address\" : \"address\",    (string) the ecochain address\n"
            ...
            "\nExamples\n"
            + HelpExampleCli("listunspent", "")
            + HelpExampleCli("listunspent", "6 9999999 \"[\\\"EQjcYkGW3faMhFQmb7mTn8dngH2tM4CLe3\\\",\\\"EeHoFeeGsK8np3smxFuxDC9QDr9bH6TjzU\\\"]\"")
            + HelpExampleRpc("listunspent", "6, 9999999 \"[\\\"EQjcYkGW3faMhFQmb7mTn8dngH2tM4CLe3\\\",\\\"EeHoFeeGsK8np3smxFuxDC9QDr9bH6TjzU\\\"]\"")
        );
    ...
    if (request.params.size() > 2 && !request.params[2].isNull()) {
        ...
        for (unsigned int idx = 0; idx < inputs.size(); idx++) {
            ...
            if (!address.IsValid())
                throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, string("Invalid Ecoc address: ")+input.get_str());
            if (setAddress.count(address))
...
UniValue fundrawtransaction(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw runtime_error(
                            ...
                            "   {\n"
                            "     \"changeAddress\"          (string, optional, default pool address) The ecochain address to receive the change\n"
    ...
    if (request.params.size() > 1) {
      if (request.params[1].type() == UniValue::VBOOL) {
        ...
        if (options.exists("changeAddress")) {
            ...
            if (!address.IsValid())
                throw JSONRPCError(RPC_INVALID_PARAMETER, "changeAddress must be a valid ecoc address");
